...
export default function DieticianSidebar() {
  ...
  return (
    <aside className="fixed left-0 top-0 h-screen w-64 border-r border-neutral-200 bg-background flex flex-col overflow-y-auto">
      {/* Logo */}
      <div className="p-6 border-b border-neutral-200">
        ...
        <div className="mt-3 rounded-lg bg-accent-purple-50 px-3 py-1.5">
