...
export default function MemberBillingPage() {
  ...
  const paymentHistory = [
    ...
    },
    {
      id: 3,
      date: "2023-12-05",
      description: "Personal Training Session (5-pack)",
      amount: 150,
      status: "PAID",
      method: "Visa ****4242",
    ...
    <div className="flex min-h-screen bg-background">
      ...
      <main className="md:ml-64 flex-1 p-4 sm:p-6 md:p-8">
        <div className="max-w-7xl mx-auto">
          <button
            onClick={() =>
              router.push(`/dashboard/gym-owner/members/${memberId}`)
            }
                    ...
                    <tbody>
                      {paymentHistory.map((payment) => (
                        ...
                        >
                          ...
                          <td className="py-3 px-2 font-medium text-foreground text-xs sm:text-sm">
                            {payment.description}
                          </td>
                          <td className="py-3 px-2 font-semibold text-foreground text-xs sm:text-sm">
                            ${payment.amount}
                          </td>
                  ...
                  {paymentHistory.map((payment) => (
                    ...
                    >
                      <div className="flex justify-between items-start mb-2">
                        ...
                        <p className="font-bold text-foreground ml-2">
                          ${payment.amount}
                        </p>
                      </div>
