...
export default function GymOwnerDashboard() {
  ...
  const recentCheckins = [
    { name: 'John Doe', time: '2 minutes ago', plan: 'Pro', avatar: (<svg className="h-8 w-8" fill="none" viewBox="0 0 24 24" stroke="currentColor"><path strokeLinecap="round" strokeLinejoin="round" strokeWidth={2} d="M16 7a4 4 0 11-8 0 4 4 0 018 0zM12 14a7 7 0 00-7 7h14a7 7 0 00-7-7z" /></svg>) },
    { name: 'Sarah Johnson', time: '15 minutes ago', plan: 'Elite', avatar: (<svg className="h-8 w-8" fill="none" viewBox="0 0 24 24" stroke="currentColor"><path strokeLinecap="round" strokeLinejoin="round" strokeWidth={2} d="M16 7a4 4 0 11-8 0 4 4 0 018 0zM12 14a7 7 0 00-7 7h14a7 7 0 00-7-7z" /></svg>) },
    { name: 'Mike Chen', time: '28 minutes ago', plan: 'Pro', avatar: (<svg className="h-8 w-8" fill="none" viewBox="0 0 24 24" stroke="currentColor"><path strokeLinecap="round" strokeLinejoin="round" strokeWidth={2} d="M16 7a4 4 0 11-8 0 4 4 0 018 0zM12 14a7 7 0 00-7 7h14a7 7 0 00-7-7z" /></svg>) },
    { name: 'Emily Davis', time: '45 minutes ago', plan: 'Starter', avatar: (<svg className="h-8 w-8" fill="none" viewBox="0 0 24 24" stroke="currentColor"><path strokeLinecap="round" strokeLinejoin="round" strokeWidth={2} d="M16 7a4 4 0 11-8 0 4 4 0 018 0zM12 14a7 7 0 00-7 7h14a7 7 0 00-7-7z" /></svg>) },
    { name: 'James Wilson', time: '1 hour ago', plan: 'Pro', avatar: (<svg className="h-8 w-8" fill="none" viewBox="0 0 24 24" stroke="currentColor"><path strokeLinecap="round" strokeLinejoin="round" strokeWidth={2} d="M16 7a4 4 0 11-8 0 4 4 0 018 0zM12 14a7 7 0 00-7 7h14a7 7 0 00-7-7z" /></svg>) },
  ];
  ...
  const quickActions = [
    {
      label: 'Add New Class',
      icon: (<svg className="h-8 w-8" fill="none" viewBox="0 0 24 24" stroke="currentColor"><path strokeLinecap="round" strokeLinejoin="round" strokeWidth={2} d="M12 4v16m8-8H4" /></svg>),
          ...
          {stats.map((stat, index) => (
            ...
            >
              <div className="flex items-start justify-between mb-4">
                <div className={`flex h-12 w-12 items-center justify-center rounded-xl ${stat.color} ${stat.iconColor}`}>
                  {stat.icon}
                </div>
                  ...
                  <li key={index} className="pb-4 border-b border-neutral-100 last:border-0 last:pb-0">
                    <div className="flex items-start justify-between mb-2">
                      <div>
                        ...
                        <p className="text-sm text-foreground-secondary">{classItem.instructor}</p>
                      </div>
                    ...
                    <p className="text-sm font-medium text-foreground-tertiary">{classItem.time}</p>
                  </li>
                ))}
              </ul>
            </div>
