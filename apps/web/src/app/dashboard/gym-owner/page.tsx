...
export default function GymOwnerDashboard() {
  ...
  const recentCheckins = [
    { name: 'John Doe', time: '2 minutes ago', plan: 'Pro', avatar: '👨' },
    { name: 'Sarah Johnson', time: '15 minutes ago', plan: 'Elite', avatar: '👩' },
    { name: 'Mike Chen', time: '28 minutes ago', plan: 'Pro', avatar: '👨' },
    { name: 'Emily Davis', time: '45 minutes ago', plan: 'Starter', avatar: '👩' },
    { name: 'James Wilson', time: '1 hour ago', plan: 'Pro', avatar: '👨' },
  ];
