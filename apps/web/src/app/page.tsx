    ...
    <div className="min-h-screen bg-neutral-100">
          ...
          <div className="mt-16 grid gap-8 md:grid-cols-2 lg:grid-cols-3">
            {[
              ...
              return (
                ...
                >
                  <div className={`mb-4 flex h-12 w-12 items-center justify-center rounded-xl ${colorClasses[feature.color as keyof typeof colorClasses]} ${iconColorClasses[feature.color as keyof typeof iconColorClasses]}`}>
                    {feature.icon}
                  </div>
          ...
          <div className="mt-16 grid gap-8 md:grid-cols-2 lg:grid-cols-4">
            {[
              ...
              >
                ...
                <h3 className="font-display text-lg font-bold text-foreground">{location.country}</h3>
      ...
      <section className="bg-neutral-100 py-20 sm:py-28">
        <div className="mx-auto max-w-7xl px-4 sm:px-6 lg:px-8">
          <div className="grid items-center gap-12 lg:grid-cols-2">
            <div>
              <div className="mb-4 inline-flex items-center gap-2 rounded-full bg-accent-blue-500/10 px-4 py-2">
                <svg className="h-5 w-5 text-accent-blue-500" fill="currentColor" viewBox="0 0 20 20">
                  <path fillRule="evenodd" d="M6.267 3.455a3.066 3.066 0 001.745-.723 3.066 3.066 0 013.976 0 3.066 3.066 0 001.745.723 3.066 3.066 0 012.812 2.812c.051.643.304 1.254.723 1.745a3.066 3.066 0 010 3.976 3.066 3.066 0 00-.723 1.745 3.066 3.066 0 01-2.812 2.812 3.066 3.066 0 00-1.745.723 3.066 3.066 0 01-3.976 0 3.066 3.066 0 00-1.745-.723 3.066 3.066 0 01-2.812-2.812 3.066 3.066 0 00-.723-1.745 3.066 3.066 0 010-3.976 3.066 3.066 0 00.723-1.745 3.066 3.066 0 012.812-2.812zm7.44 5.252a1 1 0 00-1.414-1.414L9 10.586 7.707 9.293a1 1 0 00-1.414 1.414l2 2a1 1 0 001.414 0l4-4z" clipRule="evenodd" />
                </svg>
                <span className="text-sm font-semibold text-accent-blue-600">Seamless Access</span>
              </div>
              <h2 className="font-display text-3xl font-black leading-tight text-foreground sm:text-4xl lg:text-5xl">
            ...
            <div className="relative">
              <div className="relative overflow-hidden rounded-3xl bg-gradient-to-br from-accent-blue-500 to-accent-blue-600 p-12 text-center shadow-2xl">
                {/* QR Code Visual */}
                <div className="mx-auto w-64 rounded-2xl bg-white p-6">
                ...
                <p className="mt-6 font-semibold text-white">Scan to check in</p>
                <p className="mt-2 text-sm text-white/80">Elite Fitness Center - Downtown</p>
              </div>
            </div>
          </div>
        </div>
        ...
        <div className="mx-auto max-w-7xl px-4 sm:px-6 lg:px-8">
          ...
          <div className="mt-16 grid gap-8 md:grid-cols-3">
            {[
              ...
              <div
                key={index}
                className="group relative overflow-hidden rounded-2xl bg-background p-8 shadow-card transition-all duration-300 hover:shadow-xl hover:-translate-y-1"
              >
                <div className="absolute right-4 top-4 text-6xl font-black text-neutral-200 opacity-50">
                  {item.step}
                </div>
                <div className="relative">
          ...
          <div className="mt-16 overflow-hidden rounded-3xl bg-primary-500 p-12 text-center">
            <div className="mx-auto max-w-2xl">
              ...
              <div className="mt-8 flex flex-wrap justify-center gap-4 text-sm text-foreground-secondary">
                <div className="flex items-center gap-2">
          ...
          <div className="grid gap-12 sm:grid-cols-2 lg:grid-cols-4">
            ...
            <div>
              ...
              <div className="mt-6 flex gap-4">
                <a href="#" className="text-foreground-tertiary transition-colors duration-200 hover:text-accent-blue-500">
