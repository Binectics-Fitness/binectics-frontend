        ...
        <div className="p-6 border-b border-neutral-200">
          ...
          <div className={`mt-4 flex ${isCollapsed ? 'justify-center' : 'justify-end'}`}>
            <button
              ...
              className="w-8 h-8 bg-white rounded-full shadow-lg flex items-center justify-center border-2 border-neutral-200 hover:border-accent-yellow-500 transition-all duration-300"
