  ...
  return (
    <>
      ...
      <button
        ...
        className={`fixed top-1/2 -translate-y-1/2 z-50 w-8 h-8 bg-white rounded-full shadow-lg flex items-center justify-center border-2 border-neutral-200 hover:border-accent-blue-500 transition-all duration-300 ${
