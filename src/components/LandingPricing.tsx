    ...
    <div>
      ...
      {audience === "provider" && (
        <div className="grid grid-cols-1 sm:grid-cols-3 border border-border rounded-(--r-3) bg-bg mt-3 sm:min-h-[420px]">
          {/* Starter */}
          <div className="p-6 sm:p-8 flex flex-col gap-3.5 border-b sm:border-b-0 sm:border-r border-border">
          ...
          {/* Studio */}
          <div className="p-6 sm:p-8 flex flex-col gap-3.5 border-b sm:border-b-0 sm:border-r border-border relative" style={{ background: "var(--bg-2)" }}>
            {isAnnual && (
          ...
          {/* Enterprise */}
          <div className="p-6 sm:p-8 flex flex-col gap-3.5" style={{ background: "var(--ink)" }}>
      ...
      {audience === "member" && (
        <div className="grid grid-cols-1 sm:grid-cols-3 border border-border rounded-(--r-3) bg-bg mt-3 sm:min-h-[420px]">
          ...
          <div className="p-6 sm:p-8 flex flex-col gap-3.5 border-b sm:border-b-0 sm:border-r border-border relative" style={{ background: "var(--bg-2)" }}>
            <span className="absolute font-mono text-[10.5px] uppercase tracking-[0.05em] inline-flex items-center gap-1.25 rounded-full" style={{ top: "-10px", left: "24px", padding: "4px 10px", background: "var(--ink)", color: "var(--bg)" }}>
              <span className="w-1.25 h-1.25 rounded-full" style={{ background: "var(--signal)" }} />
              {isAnnual ? "Save 2 months" : "Coming soon"}
            </span>
