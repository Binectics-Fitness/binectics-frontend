...
export default function Navbar() {
  ...
  return (
    <header className="sticky top-0 z-50 border-b border-neutral-200 bg-background-secondary/95 backdrop-blur-md shadow-[0_1px_3px_rgb(0_0_0/0.04)] supports-[backdrop-filter]:bg-background-secondary/95">
