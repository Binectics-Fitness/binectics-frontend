...
export default function DieticianSidebar() {
  ...
  return (
    <>
      <aside
        className={`fixed left-0 top-0 h-screen border-r border-neutral-200 bg-background flex flex-col overflow-y-auto transition-all duration-300 ${isCollapsed ? "w-20" : "w-64"}`}
      >
        {/* Logo */}
        <div className="p-6 border-b border-neutral-200">
          ...
          {!isCollapsed && (
            <div className="mt-3 bg-accent-purple-50 px-3 py-1.5">
              <p className="text-xs font-semibold text-accent-purple-700">
                Dietician
              </p>
            </div>
          )}
        ...
        <button
          ...
          className={`fixed z-50 w-8 h-8 bg-white rounded-full shadow-lg flex items-center justify-center border-2 border-neutral-200 hover:border-accent-purple-500 transition-all duration-300 ${
