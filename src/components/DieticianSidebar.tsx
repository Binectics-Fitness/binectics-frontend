  ...
  return (
    <>
        ...
        <div className="p-6 border-b border-neutral-200">
          ...
          {!isCollapsed && (
            <div className="mt-3 bg-accent-purple-50 px-3 py-1.5">
              <p className="text-xs font-semibold text-accent-purple-700">Dietician</p>
            </div>
          )}
        </div>
      ...
      <button
        ...
        className={`fixed top-1/2 -translate-y-1/2 z-50 w-8 h-8 bg-white rounded-full shadow-lg flex items-center justify-center border-2 border-neutral-200 hover:border-accent-purple-500 transition-all duration-300 ${
