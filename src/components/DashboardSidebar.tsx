...
export default function DashboardSidebar() {
  ...
  const bottomNavItems = [
    ...
    },
    {
      ...
      label: "Logout",
      onClick: () => {
        console.log("Logout button clicked in DashboardSidebar");
        logout();
      },
      isLink: false,
    },
  ...
  return (
    <>
      <aside
        className={`fixed left-0 top-0 h-screen border-r border-neutral-200 bg-background flex flex-col transition-all duration-300 ${isCollapsed ? "w-20" : "w-64"}`}
      >
        {/* Logo */}
