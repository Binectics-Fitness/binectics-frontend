  ...
  const testimonials = [
    {
      ...
      date: "2024-02-12",
      comment:
        "Dr. Thompson completely changed my relationship with food. Lost 35 lbs and kept it off for 2 years!",
    ...
    },
    {
      ...
      date: "2024-02-08",
      comment:
        "As an athlete, I needed expert nutrition guidance. Sarah's sports nutrition knowledge is incredible.",
    ...
    },
    {
      ...
      date: "2024-01-30",
      comment:
        "Professional, knowledgeable, and genuinely cares about her clients. Highly recommend!",
      program: "3-Month Transformation",
    },
  ];
                  ...
                  >
                    ...
                    <ul className="space-y-1 mt-3">
                      {plan.features.map((feature, index) => (
                        ...
                        >
                          <svg
                            className="w-4 h-4 text-accent-purple-500 mt-0.5"
                            fill="currentColor"
                            viewBox="0 0 20 20"
                          >
                            <path
