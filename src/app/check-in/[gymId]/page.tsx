    ...
    return (
      <div className="min-h-screen bg-background flex items-center justify-center p-4">
        <div className="max-w-md w-full bg-white rounded-2xl shadow-lg p-8 text-center">
          ...
          <h1 className="text-3xl font-black text-foreground mb-3">Check-in Successful!</h1>
          ...
          <p className="text-xs text-foreground/40 mt-4">Redirecting to dashboard...</p>
        </div>
      </div>
    );
  }
      ...
      <div className="max-w-md w-full bg-white rounded-2xl shadow-lg overflow-hidden">
        ...
        <div className="bg-accent-blue-500 p-6 text-center">
          <div className="w-20 h-20 bg-white rounded-full flex items-center justify-center mx-auto mb-4">
            <svg className="w-10 h-10 text-accent-blue-500" fill="none" stroke="currentColor" viewBox="0 0 24 24">
