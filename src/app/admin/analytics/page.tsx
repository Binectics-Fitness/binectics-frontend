        ...
        <header className="bg-white border-b border-gray-200">
          <div className="px-4 py-4 sm:px-6 sm:py-5 md:px-8 md:py-6">
            ...
            <p className="mt-1 text-foreground/60">
              Insights and metrics for the entire platform
            </p>
          </div>
        </header>
              ...
              <div className="space-y-6">
                {categoryDistribution.map((category, index) => (
                  <div key={index} className="flex items-center gap-4">
                    <div
                      className={`w-16 h-16 ${category.color} flex items-center justify-center`}
                    >
                    ...
                    <div className="flex-1">
                      ...
                      <p className="text-sm text-foreground/60">
                        {((category.count / 3842) * 100).toFixed(1)}% of total
                        subscriptions
                      </p>
                    </div>
                  </div>
