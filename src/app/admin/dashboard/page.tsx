...
export default function AdminDashboardPage() {
  ...
  const recentActivity = [
    {
      user: "John Smith",
      action: "Registered as Gym Owner",
      time: "5 minutes ago",
      type: "user",
    },
    {
    ...
    {
      user: "PowerHouse Gym",
      action: "New subscription payment received",
      time: "23 minutes ago",
      type: "payment",
    },
    {
      user: "Mike Davis",
      action: "Verified as Personal Trainer",
      time: "1 hour ago",
      type: "verification",
    },
    {
      user: "Emily Brown",
      action: "Reported a violation",
      time: "2 hours ago",
      type: "warning",
    },
  ];
  ...
  const pendingActions = [
    {
      id: 1,
      title: "Review 12 verification applications",
      priority: "high",
      count: 12,
    },
    {
      id: 2,
      title: "Respond to 5 support tickets",
      priority: "medium",
      count: 5,
    },
    {
      id: 3,
      title: "Review 3 flagged content items",
      priority: "high",
      count: 3,
    },
    {
      id: 4,
      title: "Approve 8 pending provider profiles",
      priority: "low",
      count: 8,
    },
  ];
            ...
            >
              <div className="flex items-center gap-4">
                <div className="p-3 bg-accent-blue-100 rounded-lg">
                  <svg
                    className="w-6 h-6 text-accent-blue-600"
                    fill="none"
                    viewBox="0 0 24 24"
                    stroke="currentColor"
                  >
            ...
            >
              <div className="flex items-center gap-4">
                <div className="p-3 bg-accent-yellow-100 rounded-lg">
                  <svg
                    className="w-6 h-6 text-accent-yellow-600"
                    fill="none"
                    viewBox="0 0 24 24"
                    stroke="currentColor"
                  >
            ...
            >
              <div className="flex items-center gap-4">
                <div className="p-3 bg-accent-purple-100 rounded-lg">
                  <svg
                    className="w-6 h-6 text-accent-purple-600"
                    fill="none"
                    viewBox="0 0 24 24"
                    stroke="currentColor"
                  >
