      ...
      >
        ...
        >
          ...
          <div className="flex flex-col gap-2.5 shrink-0">
            ...
            >
              <svg width="20" height="20" viewBox="0 0 512 512" fill="var(--ink)">
                <path d="M48 59.49v393a4.33 4.33 0 007.37 3.07L260 256 55.37 56.42A4.33 4.33 0 0048 59.49zM345.8 174L89.22 32.64l-.16-.09c-4.42-2.4-8.62 3.58-5 7.06l201.13 192.32zM84.08 472.39c-3.64 3.48.56 9.46 5 7.06l.16-.09L345.8 338l-60.61-57.95zM449.38 231l-71.65-39.46L310.36 256l67.37 64.43 71.65-39.46c19.74-10.86 19.74-39.12 0-49.97z" />
              </svg>
              <div>
                <div
                  className="text-[13px] font-medium"
