  ...
  const values = [
    {
      title: "Member First",
      description:
        "Every decision starts with how it impacts our members and their fitness journey.",
    },
    {
      title: "Move Fast",
      description:
        "We iterate quickly, learn from failures, and ship improvements continuously.",
    },
    {
      title: "Own It",
      description:
        "Take ownership of problems and solutions. No task is beneath anyone.",
    },
    {
      ...
      <section className="bg-background py-16 sm:py-28">
        <div className="mx-auto max-w-4xl px-4 sm:px-6 lg:px-8 text-center">
          ...
          <p className="mt-6 text-lg sm:text-xl text-foreground-secondary leading-relaxed">
            Help us connect millions of people to gyms, trainers, and wellness
            professionals worldwide. We're building something big, and we want
