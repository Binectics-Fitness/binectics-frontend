...
export const metadata: Metadata = {
  ...
  description:
    "Binectics Terms of Service — the rules and guidelines for using the Binectics platform.",
};
      ...
      <section className="bg-background py-16 sm:py-28">
        <div className="mx-auto max-w-4xl px-4 sm:px-6 lg:px-8">
          ...
          <p className="mt-4 text-base text-foreground-secondary leading-relaxed">
            Please read these Terms of Service carefully before using Binectics.
