              ...
              {plan.delivery_type === DietPlanDeliveryType.DOCUMENT &&
                plan.document_file_name && (
                  <button
                    ...
                    className="rounded-2xl bg-white p-6 shadow-[var(--shadow-card)] text-left hover:ring-2 hover:ring-accent-blue-200 transition-shadow cursor-pointer disabled:opacity-50"
                  >
                    <p className="text-sm text-foreground-secondary">
                      Document
                    </p>
                    ...
                    <p className="text-xs text-accent-blue-500 mt-1 font-medium">
                ...
                <div className="flex items-center gap-4">
                  ...
                  >
                    ...
                    <div className="min-w-0">
                      ...
                      <p className="text-xs text-foreground-secondary">
                        {loadingPreview
                          ? "Loading preview…"
                          : "Click to preview — or use buttons to download"}
                      </p>
                    </div>
                  </button>
                  <div className="flex items-center gap-2 shrink-0">
                    <button
                      onClick={handlePreviewDocument}
                      disabled={loadingPreview}
                      className="inline-flex h-10 items-center justify-center gap-2 rounded-lg border border-accent-blue-200 bg-white px-4 text-sm font-medium text-accent-blue-600 hover:bg-accent-blue-50 disabled:opacity-50"
                    >
                      <svg
                        className="h-4 w-4"
                        fill="none"
