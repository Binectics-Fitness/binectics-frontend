  ...
  return (
    <DietitianDashboardShell activeItem={"Settings"} crumb={"Settings"}>
      <FeaturePending
        ...
        pendingBody={"Dietitian-specific preferences (consultation policies, intake defaults) will appear here once built. Your account settings \u2014 profile, password, notifications, privacy \u2014 are real and live today."}
