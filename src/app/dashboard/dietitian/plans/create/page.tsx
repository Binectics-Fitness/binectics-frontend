...
export default function DietitianCreatePlanPage() {
    ...
    <div className="flex min-h-screen bg-background">
      ...
      <main className="md:ml-64 flex-1 p-4 sm:p-6 md:p-8">
        <div className="max-w-4xl mx-auto">
          ...
          <p className="text-foreground/60 mb-8">Set up a service plan for your clients</p>
              ...
              <div className="grid grid-cols-1 md:grid-cols-2 gap-4">
                <div className="md:col-span-2">
                  ...
                  <input
                    ...
                    placeholder="e.g. Monthly Nutrition Coaching"
                  />
            ...
            <div className="bg-white rounded-xl shadow-card p-6">
              ...
              <div className="flex gap-2 mb-4">
                <input
                  ...
                  placeholder="Add a feature (e.g. Personalized meal plans)"
                />
                <button
                  type="button"
                  onClick={addFeature}
