...
export default function InstanceClient({ instanceId }: { instanceId: string }) {
  ...
  return (
    <DietitianDashboardShell activeItem="Programs" crumb="Program progress">
      <Link href="/dashboard/dietitian/programs" className="text-[12.5px] inline-flex items-center gap-1.5 mb-2" style={{ color: "var(--fg-3)" }}>
