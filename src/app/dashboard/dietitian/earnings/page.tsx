...
import { minorToMajor, formatMinorMap, dominantCurrency } from "./minorMoney";
    ...
    <DietitianDashboardShell activeItem="Earnings" crumb="Earnings">
      <div>
        ...
        <p className="text-[13.5px] mt-1.5" style={{ color: "var(--fg-3)" }}>
          Settled revenue from your organization&rsquo;s ledger, plus your consultation activity
        </p>
      </div>
              ...
              <div className="px-4.5 py-4 flex flex-col gap-2.5">
                {estimatedEntries.length === 0 ? (
                  <EmptySlate
                    ...
                    hint="Set prices on your consultation types to see an estimated value for completed sessions."
                    mt="mt-0"
                  />
                ) : (
                ...
                {session.estimated.unpriced_sessions > 0 && (
                  <div className="text-[12.5px]" style={{ color: "var(--fg-2)" }}>
                    ...
                    <Link href="/dashboard/dietitian/settings" className="underline" style={{ color: "var(--ink)" }}>
                      set prices on your consultation types
                    </Link>{" "}
                    to include them.
                  </div>
                )}
