    ...
    <div className="space-y-6">
      ...
      <div className="rounded-xl bg-white p-4 shadow-card sm:p-6">
          ...
          <div className="space-y-2">
            {[
              ...
              },
              {
                value: "members",
                title: "Members Only",
                desc: "Only Binectics members can view your profile",
              },
              {
                value: "private",
                title: "Private",
        ...
        <div className="space-y-4 pt-4 border-t border-gray-200">
          ...
          />
          <PrivacyToggle
            label="Show Fitness Progress"
            description="Allow others to see your workout stats and achievements"
      ...
      <div className="rounded-xl bg-white p-4 shadow-card sm:p-6">
        ...
        <div className="space-y-4">
          <PrivacyToggle
            ...
            description="Track your workout sessions, check-ins, and engagement"
            checked={privacy.allowActivityTracking}
            onChange={() => handleToggle("allowActivityTracking")}
          />
          <PrivacyToggle
            label="Performance Analytics"
            description="Allow Binectics to analyze your performance data for insights"
            checked={privacy.allowPerformanceAnalytics}
            onChange={() => handleToggle("allowPerformanceAnalytics")}
          />
          <PrivacyToggle
            label="Share Data with Providers"
            description="Share your activity data with your trainers and gyms"
            checked={privacy.shareDataWithProviders}
            onChange={() => handleToggle("shareDataWithProviders")}
          />
        </div>
      </div>
      ...
      <div className="rounded-xl bg-white p-4 shadow-card sm:p-6">
        ...
        <div className="space-y-4">
          ...
          <PrivacyToggle
            ...
            description="Receive messages from trainers, gyms, and dietitians"
            checked={privacy.allowProviderMessages}
            onChange={() => handleToggle("allowProviderMessages")}
          />
          <PrivacyToggle
            label="Marketing Communications"
            description="Receive marketing emails from Binectics partners"
      ...
      <div className="rounded-xl bg-white p-4 shadow-card sm:p-6">
        ...
        <div className="space-y-4">
          <PrivacyToggle
            ...
            description="Allow Binectics to share your data with trusted third-party partners"
            checked={privacy.shareWithThirdParties}
            onChange={() => handleToggle("shareWithThirdParties")}
          />
          <PrivacyToggle
            label="Anonymous Data Collection"
            description="Contribute anonymous usage data to help improve Binectics"
            checked={privacy.allowAnonymousData}
            onChange={() => handleToggle("allowAnonymousData")}
          />
        </div>
      </div>
        ...
        <div className="space-y-4">
          <div className="p-4 bg-gray-50 border border-gray-200 rounded-lg">
            ...
            <p className="text-sm text-foreground/70 mb-4">
              Request a copy of all your personal data stored on Binectics.
            </p>
            <button
