                ...
                {[5, 4, 3, 2, 1].map((star) => {
                  ...
                  const pct =
                    aggregate.totalReviews > 0
                      ? (count / aggregate.totalReviews) * 100
                      : 0;
                  return (
                    <div key={star} className="flex items-center gap-2 text-sm">
                      <span className="w-3 text-foreground-secondary">
                        {star}
                      </span>
                      <svg
                        className="h-3.5 w-3.5 text-accent-yellow-500"
                        fill="currentColor"
                        viewBox="0 0 20 20"
                      >
                        <path d="M9.049 2.927c.3-.921 1.603-.921 1.902 0l1.07 3.292a1 1 0 00.95.69h3.462c.969 0 1.371 1.24.588 1.81l-2.8 2.034a1 1 0 00-.364 1.118l1.07 3.292c.3.921-.755 1.688-1.54 1.118l-2.8-2.034a1 1 0 00-1.175 0l-2.8 2.034c-.784.57-1.838-.197-1.539-1.118l1.07-3.292a1 1 0 00-.364-1.118L2.98 8.72c-.783-.57-.38-1.81.588-1.81h3.461a1 1 0 00.951-.69l1.07-3.292z" />
                      ...
                      <div className="flex-1 h-2 rounded-full bg-neutral-100">
                        <div
                          className="h-2 rounded-full bg-accent-yellow-500 transition-all"
                          style={{ width: `${pct}%` }}
                        />
                      </div>
                    ...
                    {respondingTo === review.id ? (
                      <div className="mt-4 space-y-2">
                        <textarea
                          ...
                          className="w-full rounded-lg border border-neutral-200 p-3 text-sm text-foreground placeholder:text-foreground-secondary/50 focus:border-accent-blue-500 focus:outline-none"
                          rows={3}
                        />
                      ...
                      <button
                        ...
                        className="mt-3 text-sm font-semibold text-accent-blue-500 hover:text-accent-blue-600"
                      >
                        Respond
                      </button>
                    )}
