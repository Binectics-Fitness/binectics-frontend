      ...
      <main className="md:ml-64 flex-1 p-4 sm:p-6 md:p-8">
        ...
        {loadingData && (
          <div className="flex items-center justify-center py-16">
            <div className="h-8 w-8 animate-spin rounded-full border-4 border-accent-yellow-500 border-r-transparent" />
          </div>
        )}
        ...
        {selectedProfile && selectedSummary && !loadingData && (
          <div className="mb-8">
            <button
              ...
              className="mb-4 flex items-center gap-1 text-sm font-medium text-accent-yellow-600 hover:text-accent-yellow-700"
            >
              <svg
                className="h-4 w-4"
                fill="none"
                  ...
                  {selectedProfile.goals.length > 0 && (
                    <div className="mt-2 flex flex-wrap gap-1">
                      {selectedProfile.goals.map((g) => (
                        <span
                          key={g}
                          className="rounded-full bg-accent-yellow-100 px-2 py-0.5 text-xs font-medium text-accent-yellow-700"
                        >
                          {g}
                        </span>
                      ))}
                ...
                >
                  ...
                  <div className="mt-3 flex justify-end">
                    <button
                      ...
                      className="rounded-lg bg-accent-yellow-500 px-4 py-2 text-sm font-semibold text-foreground hover:bg-accent-yellow-600 disabled:opacity-50"
                    >
                      ...
                      <div className="flex items-start justify-between gap-4">
                        <div>
                          ...
                          <div className="mt-1 flex flex-wrap gap-2 text-xs text-foreground-tertiary">
                            ...
                            {entry.mood && (
                              <span className="rounded-full bg-accent-yellow-100 px-2 py-0.5 text-accent-yellow-700">
                                {entry.mood}
                              </span>
                            )}
          ...
          <>
            {profiles.length === 0 && (
              <div className="flex flex-col items-center justify-center py-24 text-center">
                ...
                <button
                  onClick={() => setShowAddModal(true)}
                  className="mt-6 rounded-lg bg-accent-yellow-500 px-4 py-2 text-sm font-semibold text-foreground hover:bg-accent-yellow-600"
                >
                  + Add Client
                </button>
              </div>
                    ...
                    >
                      <div className="flex items-start justify-between">
                        <div className="flex items-center gap-3">
                          <div className="flex h-10 w-10 items-center justify-center rounded-full bg-accent-yellow-100">
                            <svg
                      ...
                      {p.goals.length > 0 && (
                        <div className="mt-3 flex flex-wrap gap-1">
                          {p.goals.slice(0, 3).map((g) => (
                            <span
                              key={g}
                              className="rounded-full bg-accent-yellow-50 px-2 py-0.5 text-xs text-accent-yellow-600"
                            >
                              {g}
                            </span>
                          ))}
          ...
          >
            ...
            <label className="block">
              ...
              <input
                ...
                type="text"
                className="mt-1 block w-full rounded-lg border border-neutral-300 px-3 py-2 text-sm"
                placeholder="Comma-separated, e.g. Build muscle, Increase strength"
              />
            </label>
            <label className="block">
