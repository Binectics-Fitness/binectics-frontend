...
export default function TrainerEditPlanPage() {
    ...
    <div className="flex min-h-screen bg-background">
      ...
      <main className="md:ml-64 flex-1 p-4 sm:p-6 md:p-8">
        <div className="max-w-4xl mx-auto">
          <button
            onClick={() => router.push(`/dashboard/trainer/plans/${planId}`)}
          ...
          <p className="text-foreground/60 mb-8">Update your training plan details</p>
          ...
          <form onSubmit={handleSubmit(onSubmit)} className="space-y-6">
            <div className="bg-white rounded-xl shadow-card p-6">
              <div className="grid grid-cols-1 md:grid-cols-2 gap-4">
                <div className="md:col-span-2">
                  ...
                  <input type="text" {...register("name")} className="w-full px-4 py-3 border border-gray-200 rounded-lg focus:outline-none focus:ring-2 focus:ring-accent-yellow-500" />
                  {errors.name && <p className="text-sm text-red-600 mt-1">{errors.name.message}</p>}
                </div>
                <div>
                  <label className="block text-sm font-medium text-foreground/70 mb-2">Plan Type *</label>
                  <select {...register("plan_type")} className="w-full px-4 py-3 border border-gray-200 rounded-lg focus:outline-none focus:ring-2 focus:ring-accent-yellow-500">
                ...
                <div>
                  ...
                  <input type="number" {...register("duration_days")} className="w-full px-4 py-3 border border-gray-200 rounded-lg focus:outline-none focus:ring-2 focus:ring-accent-yellow-500" />
                ...
                <div>
                  ...
                  <input type="number" step="0.01" {...register("price")} className="w-full px-4 py-3 border border-gray-200 rounded-lg focus:outline-none focus:ring-2 focus:ring-accent-yellow-500" />
                  {errors.price && <p className="text-sm text-red-600 mt-1">{errors.price.message}</p>}
                </div>
                <div>
                  <label className="block text-sm font-medium text-foreground/70 mb-2">Currency *</label>
                  <select {...register("currency")} className="w-full px-4 py-3 border border-gray-200 rounded-lg focus:outline-none focus:ring-2 focus:ring-accent-yellow-500">
                    {currencies.length === 0 ? (
                ...
                <div className="md:col-span-2">
                  ...
                  <textarea rows={4} {...register("description")} className="w-full px-4 py-3 border border-gray-200 rounded-lg focus:outline-none focus:ring-2 focus:ring-accent-yellow-500" />
                </div>
              </div>
            </div>
            ...
            <div className="bg-white rounded-xl shadow-card p-6">
              ...
              <div className="flex gap-2 mb-4">
                <input
                  ...
                  className="flex-1 px-4 py-3 border border-gray-200 rounded-lg focus:outline-none focus:ring-2 focus:ring-accent-yellow-500"
                />
                <button type="button" onClick={addFeature} className="px-6 py-3 bg-accent-yellow-500 text-foreground font-semibold rounded-lg hover:bg-accent-yellow-600">
                  Add
                </button>
              </div>
            ...
            <label className="inline-flex items-center gap-3 text-sm text-foreground/80">
              <input
                ...
                className="h-4 w-4 rounded border-gray-300 text-accent-yellow-500 focus:ring-accent-yellow-500"
              />
              Show this plan publicly in marketplace listing
            </label>

            <div className="flex gap-4">
              <button type="button" onClick={() => router.push(`/dashboard/trainer/plans/${planId}`)} className="flex-1 px-6 py-3 bg-gray-200 text-foreground font-semibold rounded-lg hover:bg-gray-300">
                Cancel
              </button>
              <button type="submit" disabled={isSaving} className="flex-1 px-6 py-3 bg-accent-yellow-500 text-foreground font-semibold rounded-lg hover:bg-accent-yellow-600 disabled:opacity-50">
