...
export default function PlanDetailPage() {
  ...
  const handleDeletePlan = () => {
    requestConfirmation({
      title: "Delete plan?",
      description:
        "All active subscriptions will need to be migrated before this plan can be removed safely.",
      confirmLabel: "Delete Plan",
      onConfirm: async () => {
        await showAlert("Plan deleted successfully");
        ...
        <div className="max-w-7xl mx-auto">
          ...
          <div className="flex justify-between items-start mb-8">
            ...
            <div className="flex gap-3">
              <button
                onClick={() =>
                  router.push(`/dashboard/gym-owner/plans/${planId}/edit`)
                }
