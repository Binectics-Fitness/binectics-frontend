      ...
      <main className="md:ml-64 flex-1 p-4 sm:p-6 md:p-8">
        <div className="max-w-4xl mx-auto">
          ...
          <p className="text-xs sm:text-sm text-foreground/60 mb-6 sm:mb-8">
            Send an invitation to a personal trainer to join your gym
          </p>

          <form
            onSubmit={handleSubmit}
            className="bg-white rounded-lg sm:rounded-xl shadow-card p-4 sm:p-6 md:p-8"
          >
            {/* Trainer Information */}
              ...
              <div className="grid grid-cols-1 sm:grid-cols-2 gap-4 sm:gap-6">
                ...
                <div>
                  ...
                  >
                    ...
                    <option value="Pilates Instructor">
                      Pilates Instructor
                    </option>
                ...
                <div>
                  ...
                  <input
                    ...
                    onChange={(e) =>
                      setFormData({ ...formData, revenueShare: e.target.value })
                    }
                    className="w-full px-3 sm:px-4 py-2 sm:py-3 border-2 border-gray-200 rounded-lg focus:border-accent-blue-500 focus:outline-none text-sm"
                    placeholder="70"
                    min="0"
                  ...
                  <p className="text-xs text-foreground/60 mt-1">
                    Trainer receives {formData.revenueShare}%, Gym keeps{" "}
                    {100 - parseInt(formData.revenueShare || "0")}%
                  </p>
                </div>
              </div>
            </div>
            ...
            <div className="mb-6 sm:mb-8 p-4 sm:p-6 bg-accent-blue-50 border-2 border-accent-blue-200 rounded-lg">
              ...
              <ul className="text-xs sm:text-sm text-foreground/80 space-y-1">
                <li>
                  • Trainer earns {formData.revenueShare}% from their personal
                  training clients
                </li>
                <li>
                  • Gym receives {100 - parseInt(formData.revenueShare || "0")}%
                  as facility fee
                </li>
                <li>
                  • Payments from trainer&apos;s clients are split automatically
                </li>
                <li>
                  • Gym membership fees are separate and go 100% to the gym
                </li>
                <li>
                  • Revenue share can be adjusted later from trainer settings
                </li>
              </ul>
            </div>
            ...
            <div className="mb-8 p-6 bg-gray-50 rounded-lg">
              ...
              <div className="space-y-2 text-sm">
                ...
                <p className="text-foreground/80">
                  <strong>Subject:</strong> You&apos;re invited to join our gym
                  as a {formData.role}
                </p>
                <div className="mt-4 p-4 bg-white rounded border border-gray-200">
                  ...
                  <p className="text-foreground/80 mb-2">
                    We&apos;d love to have you join our team at [Gym Name] as a{" "}
                    {formData.role}.
                  </p>
                  {formData.message && (
                    <p className="text-foreground/80 mb-2 italic">
                      {formData.message}
                    </p>
                  )}
                  <p className="text-foreground/80 mb-2">
                    <strong>Your revenue share:</strong> {formData.revenueShare}
                    % from your clients
                  </p>
                  <p className="text-foreground/80">
