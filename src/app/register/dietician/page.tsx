        ...
        <div className="mx-auto max-w-md px-4 sm:px-6 lg:px-8">
          ...
          <form onSubmit={handleSubmit} className="space-y-6">
              ...
              <div className="flex gap-3">
                ...
                <div className="flex-1">
                  ...
                  <p className="text-sm text-accent-purple-700">
                    ...
                    credentials, license, specialties, and professional details.
                  </p>
                </div>
              </div>
            </div>
            ...
            <button
              ...
              className="w-full h-12 rounded-lg bg-accent-purple-500 text-base font-semibold text-white shadow-button transition-colors duration-200 hover:bg-accent-purple-600 active:bg-accent-purple-700 disabled:opacity-50 disabled:cursor-not-allowed"
            >
